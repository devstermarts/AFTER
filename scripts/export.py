...
FLAGS = flags.FLAGS
# Flags definition
flags.DEFINE_string("name", default="./after_runs/test", help="Name of the experiment folder")
flags.DEFINE_integer("step", default=0, help="Step number of checkpoint")
flags.DEFINE_string("out_name", default="after.test", help="Output name")
flags.DEFINE_string("emb_model_path_encode", default="./pretrained/test.ts", help="Path to encoder model")
flags.DEFINE_string("emb_model_path_decode", default="./pretrained/test.ts", help="Path to decoder model")
